    ...
    <div className="container">
      ...
      <div className="skills">
        ...
        <Skill
          ...
          keywords={['netlinking', 'contenu', 'maillage', 'mots-clés', 'referencement naturel', 'optimisation', 'metadonnées', 'backlinks', 'blog', '…']}
          image={<ImageSeo/>}
        />
        <Skill
          ...
          keywords={['debug','audit', 'dépannage', 'nettoyage', 'sécurisation', 'surveillance', '…']}
          image={<ImageSecurite/>}
        />
        <Skill
          title="Conseil, expertise technique et formations"
          description="Vous aimez faire les choses par vous même mais vous avez peur de tout casser ? Vous voulez vous re-positionner sur la toile et maîtriser votre image sur internet ? Après 7 ans à travailler avec WordPress et son écosystème nous pouvons sûrement répondre à vos questions."
